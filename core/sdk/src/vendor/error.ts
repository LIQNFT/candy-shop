export enum CandyShopErrorType {
  ...
  InsufficientSftBalance = 'InsufficientSftBalance',
  InvalidTokenAmount = 'InvalidTokenAmount',
  UnsupportedTokenStandard = 'UnsupportedTokenStandard',
...
export const CandyShopErrorMsgMap = {
  ...
  [CandyShopErrorType.InsufficientSftBalance]: 'Not enough tokens availale to fulfill order.',
  [CandyShopErrorType.InvalidTokenAmount]: 'The provided token amount is invalid for the given token standard".',
  [CandyShopErrorType.UnsupportedTokenStandard]: 'The given token standard is not supported.',
