...
export class EthereumSDK implements EthereumSDKInterface {
  ...
  makeConsumptionAllowance = async (
    ...
    const { provider, providerAddress } = await this.blockchainService.getParamData(
      metamaskProvider,
      address,
    )
    ...
    return await this.blockchainService.makeOrderConsumptionAllowance(
      baseParams,
      order,
  ...
  updateShop = async (
    ...
    return await ApiCaller.request(
      `${process.env.REACT_APP_API_URL}/shop/${event.uuid}`,
      RequestMethod.Patch,
      {
        name: event.name,
        paymentSplit: percentage,
  ...
  getOrder = async (uuid: string) => {
    return await ApiCaller.request(
      `${process.env.REACT_APP_API_URL}/order/${uuid}`,
      RequestMethod.Get,
      {},
    )
  }
  ...
  makeOrderConsumptionSignature = async (
    ...
    return await ApiCaller.request(
      `${process.env.REACT_APP_API_URL}/order/signature`,
      RequestMethod.Post,
      {
        consumptionUuid,
        signature,
  ...
  getShop = async (uuid: string) => {
    return await ApiCaller.request(
      `${process.env.REACT_APP_API_URL}/shop/${uuid}`,
      RequestMethod.Get,
      {},
    )
  }
