...
// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface BlockchainOfferAllowanceTransactionData
  extends BlockchainTransactionData<[string, boolean]> {}
// eslint-disable-next-line @typescript-eslint/no-empty-interface
...
export interface BlockchainCancelOrderTransactionData
  extends BlockchainTransactionData<OrderComponents[]> {}
