...
import { SolShopInitParams } from '../../sdk/src/shop/sol/CandyShop';
...
function getEnv(env: string): Blockchain {
  switch (env) {
    case 'devnet':
      return Blockchain.SolDevnet;
    case 'mainnet-beta':
      return Blockchain.SolMainnetBeta;
    default:
